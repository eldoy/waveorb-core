...
describe('router', () => {
  ...
  it('should match the route main function', async () => {
    const app = await loader('test/apps/app2')
  ...
  it('should match the route before function', async () => {
    const app = await loader('test/apps/app3')
    const $ = { app, params: { path: 'createProject' } }
    const result = await router($)
    expect(result.hello).toBe('bye')
  })
  ...
  it('should match the route after function', async () => {
    const app = await loader('test/apps/app4')
    const $ = { app, params: { path: 'createProject' } }
    const result = await router($)
    expect(result.hello).toBe('bye')
  })
  ...
  it('should curry function result1', async () => {
    const app = await loader('test/apps/app5')
    const $ = { app, params: { path: 'createProject' } }
    const result = await router($)
  ...
  it('should run filters', async () => {
    const app = await loader('test/apps/app6')
    const $ = { app, params: { path: 'createProject' } }
    const result = await router($)
    expect(result.hello).toBe('bye')
  })
  ...
  it('should validate data', async () => {
    const app = await loader('test/apps/app7')
    const $ = {
      app,
      params: {
        path: 'createProject',
